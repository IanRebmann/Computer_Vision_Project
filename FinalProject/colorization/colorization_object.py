...
from FinalProject.colorization.model import UNet
from FinalProject.colorization.colorization_utils import image_preprocessing, denormalize_ab
from FinalProject.colorization.colorization_model import colorization_execute
...
class ColorizationModel():
    ...
    def colorize(self, image):
        try:
            ...
            final_image = cv2.cvtColor(lab_image, cv2.COLOR_BGR2RGB)
            return final_image
        except Exception as e:
